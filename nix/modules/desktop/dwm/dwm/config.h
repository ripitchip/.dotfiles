...
static char *fonts[] = {
    "CaskaydiaMonoNerdFontMono:size=10",
    "NotoColorEmoji:pixelsize=12:antialias=true:autohint=true"};
static const char dmenufont[] = "CaskaydiaMonoNerdFontMono:size=10";
static char normbgcolor[] = "#FEDA99";     // col_second_background
static char normbordercolor[] = "#754C26"; // col_front_light
static char normfgcolor[] = "#5A3410";     // col_front_dark

static char selfgcolor[] = "#5A3410"; // col_front_dark (same as normfgcolor)
static char selbgcolor[] = "#FEAE00"; // col_background
static char selbordercolor[] = "#FEAE00"; // col_background
...
static const char *clipmd[] = {
    "clipmenu", "-i",      "-fn",
    dmenufont,  "-nb",     "#FEDA99", // col_second_background
    "-nf",      "#5A3410",            // col_front_dark
    "-sb",      "#FEAE00",            // col_background
    "-sf",      "#5A3410",            // col_front_dark (same as -nf)
    NULL};
...
static const Key keys[] = {
    ...
    {MODKEY, XK_minus, spawn,
     SHCMD("pulsemixer --change-volume -5; kill -44 $(pidof "
           "dwmblocks)")},
    ...
    {MODKEY, XK_e, spawn, {.v = (const char *[]){TERMINAL, "-e", "spf", NULL}}},
    {MODKEY | ShiftMask,
     XK_r,
     spawn,
